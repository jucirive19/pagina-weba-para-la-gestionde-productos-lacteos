...
<div class="container">
  ...
  <?php 
     try {
        ...
        $miconsulta=mysqli_query($link,"SELECT * FROM cuajada");

		while ($fila=mysqli_fetch_array($miconsulta))
		 {
            echo "</td><td>".$fila['fecha']."</td><td>".$fila['cantidad']."</td><td>".$fila['costoPr']."</td><td>".$fila['ganancia']."</tr></td>";
