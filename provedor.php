...
try {
        ...
        $prcos=$row['costoPr'];
        $nombrepro=$_POST['provedor'];
        $cantipr=$_POST['cantip'];
        $valorpr=$_POST['valorp'];
        $totalcos=($prcos+($valorpr*$cantipr));
        ...
        echo "<input type=text class=form-control value=".$totalcos." name=preciocos readonly />";
        echo "<br>";
        echo "<br>";
        ...
        echo "<br>";
        echo "<br>";
        echo"<p>Nombre del Provedro</p>";
        echo "<input type=text class=form-control value=".$nombrepro." name= provedor readonly/>";
        echo "<br>";
        echo "<br>";
        echo"<p>Cantidad del Provedro</p>";
        echo "<input type=text class=form-control value=".$cantipr." name= cantip readonly/>";
        echo "<br>";
        echo "<br>";
        echo"<p>Valor de la leche</p>";
        echo "<input type=text class=form-control value=".$valorpr." name= valorp readonly/>";
        echo "<br>";
        echo "<br>";
        echo "<input type=submit name=boton class=btn btn-primary value='confirmar'/>";
        echo "</form>";
            ...
            $consulta=mysqli_query($link,"INSERT INTO provedor (provedores,cantidad,costo,fecha) VALUES ('$nombrepro','$cantipr','$valorpr','$fecha')");

           $sql=mysqli_query($link,"UPDATE cosproducto set Nombre='$nombre', Costo='$precio', Cantidad='$cantidad', costoPR='$tocos', ganancia='$ganacia' WHERE id=$codigo")or die(mysqli_error($link)."error Actulizando");
