...
<div class="container">
  ...
  <?php 
     try {
        ...
        $miconsulta=mysqli_query($link,"SELECT * FROM compradores");

		while ($fila=mysqli_fetch_array($miconsulta))
		 {
            echo "</td><td>".$fila['nombreC']."</td><td>".$fila['producto']."</td><td>".$fila['cantidad']."</td><td>".$fila['costo']."</td><td>".$fila['fecha']."</tr></td>";
