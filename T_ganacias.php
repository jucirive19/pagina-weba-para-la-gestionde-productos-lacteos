...
<div class="container">
  ...
  <?php 
     try {
        ...
        $miconsulta=mysqli_query($link,"SELECT * FROM cosproducto");

		while ($fila=mysqli_fetch_array($miconsulta))
		 {
            echo "</td><td>".$fila['Nombre']."</td><td>".$fila['Costo']."</td><td>".$fila['Fecha']."</td><td>".$fila['Cantidad']."</td><td>".$fila['costoPr']."</td><td>".$fila['ganancia']."</tr></td>";
